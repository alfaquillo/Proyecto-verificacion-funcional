...
HD_PWD='C:/Vivado/banco_de_registros/banco_de_registros.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bancoderegistros.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bancoderegistros.tcl -notrace
